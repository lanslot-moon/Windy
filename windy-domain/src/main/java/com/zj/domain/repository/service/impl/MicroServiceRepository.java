...
public class MicroServiceRepository extends ServiceImpl<MicroServiceMapper, Microservice> implements
    ...
    public List<MicroserviceBO> getUserRelatedServices(String currentUserId) {
        ...
        List<String> serviceIds = resourceMembers.stream()
                .map(ResourceMemberBO::getResourceId)
                .collect(Collectors.toList());

        return list(Wrappers.lambdaQuery(Microservice.class)
                .in(Microservice::getServiceId, serviceIds)).stream()
